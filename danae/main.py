...
####################### A classe abaixo é o quebra-cabeca propriamente dito ######################
...
class Bloco:
    def __init__(self, img):
        ...
        ordem = ["%02d"%x for x in range(16)] # Aqui altera o tamanho da matriz
        desordem = ordem[:]
    ...
    def conta_pecas(self, valor_peca):
        """ Aqui é o código que faz o score do quebra-cabeca
        """
